...
def multiclass_nms_rbbox(multi_bboxes,
    ...
    for i in range(1, num_classes):
        ...
        _bboxes = torch.from_numpy(RotBox2Polys(_bboxes.detach().cpu().numpy())).to(multi_scores.device)
        ...
        if not DEBUG:
            ...
            try:
                ...
                cls_dets,_ = nms_op(cls_dets.detach(), score_thr)
    ...
    if bboxes:
        ...
        bboxes = multi_bboxes.new_zeros((0, 9) ) # originally 9
