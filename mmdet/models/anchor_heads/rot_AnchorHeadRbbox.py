...
from mmdet.core import ( anchor_target_rbbox, delta2bbox,
...
class rot_AnchorHeadRbbox(nn.Module):
    ...
    def __init__(self,
        ...
        super(rot_AnchorHeadRbbox, self).__init__()
    ...
    def get_anchors(self, featmap_sizes, img_metas):
        ...
        for i in range(num_levels):
            anchors = self.anchor_generators[i].gen_base_anchors(
